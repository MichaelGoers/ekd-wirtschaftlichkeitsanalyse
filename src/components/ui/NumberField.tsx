      ...
      <div className="relative">
        {withoutStepper ? (
          <input
            ...
            className="w-full rounded-lg border border-ekd-border px-4 py-2 pr-14 shadow-sm transition focus:border-ekd-primary focus:outline-none focus:ring-2 focus:ring-ekd-primary"
          />
        ) : (
          <input
            type="number"
        ...
        {suffix && (
          <span className="absolute right-4 top-1/2 -translate-y-1/2 text-ekd-text-secondary">
            {suffix}
          </span>
        )}
      </div>
